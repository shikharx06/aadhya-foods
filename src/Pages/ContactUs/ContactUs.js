          ...
          <div className="uk-width-1-2@m  uk-width-expand@s uk-margin-large-top uk-margin-large-left">
            <div className="uk-flex uk-flex-column uk-text-center uk-text-left@m ">
              ...
              >
                ...
                business or product related query, do reach out to us. We would
                be more than happy to help you with your queries if any
              </div>
              <div className="uk-margin-small-bottom">
                <a
                  href="mailto: shikharswat64@gmail.com"
                  alt="mail"

...
export default function Nav() {
    ...
    return (
        <>
            {/* Navbar for desktop */}
            <div className="uk-width-expand NavItemHover" uk-sticky=" sel-target: .uk-navbar-container; cls-active: uk-navbar-sticky; cls-inactive: uk-navbar-transparent uk-dark; top: 10">
